...
* **Interfaccia di guida e stato:** Interpreta il payload ricevuto e lo disegna sul display e-ink, mostrando all'utente:
  ...
  * Lo stato del dispositivo nelle fasi di attesa o disconnessione (indirizzo MAC per facilitare l'associazione BLE e percentuale residua della batteria).
...
* **Gestione del Risparmio Energetico:** Il sistema monitora costantemente l'alimentazione. Se il dispositivo perde la connessione Bluetooth per più di un minuto, interrompe fisicamente l'alimentazione spegnendosi del tutto (o entra automaticamente in modalità *Hibernate / Deep Sleep* se collegato via cavo), mostrando prima un'icona di splash per massimizzare la durata della batteria.
